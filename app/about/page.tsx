      ...
      <div className="space-y-8">
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Passionate developer creating innovative solutions and meaningful user experiences
          </p>
        </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <p className="text-muted-foreground">
                I'm a dedicated software developer with a passion for creating clean, 
                efficient code and building applications that solve real-world problems. 
          ...
          <CardContent className="space-y-6">
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground">
                ...
                modern state management, responsive design, and component libraries.
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground">
                ...
                Experienced in Agile methodologies, code reviews, and collaborating 
