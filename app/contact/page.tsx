    ...
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <div className="space-y-8">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <p className="text-xs text-muted-foreground text-center">
                This form is not yet connected to a backend. Please use the email below for now.
              </p>
            </CardContent>
          </Card>
        ...
        <div className="text-center space-y-4 bg-muted/50 rounded-lg p-8">
          <h2 className="text-2xl font-semibold">Let&rsquo;s Build Something Together</h2>
          <p className="text-muted-foreground">
            Whether you have a project in mind or just want to chat about technology, 
            I&rsquo;m always open to new conversations and opportunities.
          </p>
        </div>
      </div>
    </div>
